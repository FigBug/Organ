...
[InstallDelete]
Type: files;          Name: "{commoncf64}\VST\Organ.dll";   Components: vst
...
[Files]
Source: "bin\VST\Organ.dll";    DestDir: "{commoncf64}\VST";                     Flags: ignoreversion overwritereadonly; Components: vst
